<?PHP // $Id: index.php,v 1.4 2005/07/14 20:58:07 skodak Exp $
...
add_to_log($course->id, 'hiperbook', 'view all', 'index.php?id='.$course->id, '');

/// Get all the appropriate data
if (!$books = get_all_instances_in_course('hiperbook', $course)) {
...
$strchapters  = get_string('chapterscount', 'hiperbook');
...
foreach ($books as $book) {
    ...
    $count = count_records('hiperbook_chapters', 'bookid', $book->id, 'hidden', '0');
