<?php // $Id: mod.php,v 1.80.2.3 2005/10/09 19:38:57 skodak Exp $
require_once('../../config.php');
require_once('lib.php');
require_once('../../course/lib.php');
//lista os tipos de atividades
...
echo "not add";
 ...
 if (!isset($straddactivity)) {
    ...
    $output .= popup_form("exercise.php?id=$course->id&section=$section&sesskey=$USER->sesskey&add=",
...
// course_module passa a ser hiperbook_chapters_exercise
...
echo "1c";
    ...
    if (isset($_POST["course"]) and confirm_sesskey()) {    // add or update form submitted
        ...
        if (!isteacheredit($course->id)) {
            error("You can't modify this hiperbook!");
        }
