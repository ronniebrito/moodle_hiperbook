...
$tipnum = required_param('tipnum', PARAM_INT); //cm id
...
if($up==1){
 //swap!!!
	$newtipnum = $tipnum - 1;	
	$x= execute_sql("update ". $CFG->prefix."hiperbook_chapters_tips set tipnum = '55555' where tipnum='$tipnum' and chapterid = '$chapterid'");
	$x= execute_sql("update ". $CFG->prefix."hiperbook_chapters_tips set tipnum = (tipnum + 1) where  tipnum='$newtipnum' and chapterid = '$chapterid'");
	$x= execute_sql("update ". $CFG->prefix."hiperbook_chapters_tips set tipnum = '$newtipnum' where tipnum='55555' and chapterid = '$chapterid'");
...
//book_check_structure($book->id);
 redirect('tips.php?edit=1&id='.$id.'&chapterid='.$chapterid);
die;
